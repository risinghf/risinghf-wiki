...
Before using it, please pay attention to the [**IoTSquare IoT Platform User Manual**](https://wiki.risinghf.com/en/03/01/01/) and follow the steps below, assuming the user already has an account on this server.
...
2. [Register Gateway](https://wiki.risinghf.com/en/03/01/01/#_6-1-add-gateway)
...
Before using it, please take care to browse the [**IoTSquare IoT Platform User Manual**](https://wiki.risinghf.com/en/03/01/01/), and assuming that the user already has an account on this server, please follow these steps.
...
#### 4.2.4. [Add Application](https://wiki.risinghf.com/en/03/01/01/#_3-1-add-application)
...
#### 4.2.5. [Register Node](https://wiki.risinghf.com/en/03/01/01/#_4-1-add-abp-device)
...
IotSquare server expands some other functions besides the most basic LoRaWAN upstream and downstream communication. For example: [Gateway Information Management](https://wiki.risinghf.com/en/03/01/01/#_7-1-gateway-details), [Multicast Management](https://wiki.risinghf.com/en/03/01/01/#_8-1-add-multicast-group) and IotSquare upgrade and other functions. For more detailed features, please refer to IotSquare online documentation: <https://wiki.risinghf.com/en/03/01/01/#_1-introduction>.
