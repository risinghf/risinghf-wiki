---
title: RHF0M302-xxxC Gateway Module Development Manual
date: 2026-06-15 10:00:00
permalink: /01/01/09/11/
---

## 1 Introduction

RHF0M302C 8-channel LoRa gateway module is a high-performance small-size module with built-in Semtech's LoRa/LoRaWAN gateway chip SX1302. Dedicated to wireless sensing, automatic meters and other IoT applications, the RHF0M302C 8-channel LoRa gateway module can help users quickly design their own LoRa/LoRaWAN gateways. The working frequency bands supported by the half-duplex gateway module are: 470 ~ 510MHz, 868MHz and 915MHz, full-duplex gateway module are: 470 ~ 510MHz, meeting the needs of users in various regions.

In order to facilitate teaching and lower the threshold for using the RHF0M302C module, this document uses the Raspberry Pi as the main control to show how to use the RHF0M302C module.
...
```json
{
    "SX130x_conf": {
        ...
        "clksrc": 0,
        "antenna_gain": 0,
        "full_duplex": false, /* Whether to support full duplex. Half-duplex is false, full-duplex is true. */
        "fine_timestamp": {
            "enable": false,
            "mode": "all_sf"
        },
...
```json
{
    "SX130x_conf": {
        ...
        "radio_0": {
            ...
            "tx_enable": true,
            "tx_gain_lut":[
                {"rf_power": -2, "pa_gain": 0, "pwr_idx":  3},
                {"rf_power":  1, "pa_gain": 0, "pwr_idx":  6},
                {"rf_power":  3, "pa_gain": 0, "pwr_idx":  8},
                {"rf_power":  4, "pa_gain": 0, "pwr_idx":  9},
                {"rf_power":  5, "pa_gain": 0, "pwr_idx": 10},
                {"rf_power":  8, "pa_gain": 0, "pwr_idx": 13},
                ...
                {"rf_power": 20, "pa_gain": 1, "pwr_idx":  1},
                {"rf_power": 21, "pa_gain": 1, "pwr_idx":  1},
                {"rf_power": 23, "pa_gain": 1, "pwr_idx":  2},
                {"rf_power": 24, "pa_gain": 1, "pwr_idx":  2},
                {"rf_power": 25, "pa_gain": 1, "pwr_idx":  2}
            ]
        },
        "radio_1": {
            "enable": true,
...
**Note: When pa_gain of tx_gain_lut is equal to 1, pwr_idx cannot be greater than 2, otherwise the module may suffer irreversible damage.**

### 3.3 868 half-duplex profile
    ...
    "SX130x_conf": {
        ...
        "radio_0": {
            ...
            "tx_gain_lut":[
                ...
                {"rf_power":  9, "pa_gain": 0, "pwr_idx": 16},
                ...
                {"rf_power": 20, "pa_gain": 1, "pwr_idx":  1},
                {"rf_power": 22, "pa_gain": 1, "pwr_idx":  2},
                {"rf_power": 23, "pa_gain": 1, "pwr_idx":  3},
                {"rf_power": 24, "pa_gain": 1, "pwr_idx":  3}
            ]
        },
        "radio_1": {
            "enable": true,
...
**Note: When pa_gain of tx_gain_lut is equal to 1, pwr_idx cannot be greater than 3, otherwise the module may suffer irreversible damage.**

### 3.4 915 half-duplex profile
    ...
    "SX130x_conf": {
        ...
        "radio_0": {
            ...
            "tx_gain_lut":[
                ...
                {"rf_power":  1, "pa_gain": 0, "pwr_idx":  8},
                {"rf_power":  4, "pa_gain": 0, "pwr_idx": 11},
                {"rf_power":  6, "pa_gain": 0, "pwr_idx": 13},
                {"rf_power":  7, "pa_gain": 0, "pwr_idx": 14},
                {"rf_power":  8, "pa_gain": 0, "pwr_idx": 15},
                {"rf_power": 10, "pa_gain": 0, "pwr_idx": 17},
                {"rf_power": 11, "pa_gain": 0, "pwr_idx": 18},
...
```json
{
    "SX130x_conf": {
        ...
        "radio_0": {
            ...
            "tx_freq_max": 510000000,
            "rssi_offset": -205.0,
            "rssi_tcomp": {"coeff_a": 0, "coeff_b": 0, "coeff_c": -39.78, "coeff_d": 1349.50, "coeff_e": 0},
            "tx_enable": true,
            "tx_gain_lut":[
                {"rf_power": -2, "pa_gain": 0, "dac_gain": 3, "mix_gain": 15, "dig_gain": 0},
                {"rf_power":  1, "pa_gain": 0, "dac_gain": 3, "mix_gain": 15, "dig_gain": 0},
                {"rf_power":  3, "pa_gain": 0, "dac_gain": 3, "mix_gain": 15, "dig_gain": 0},
                {"rf_power":  4, "pa_gain": 1, "dac_gain": 3, "mix_gain":  6, "dig_gain": 0},
                {"rf_power":  5, "pa_gain": 1, "dac_gain": 3, "mix_gain":  6, "dig_gain": 0},
                {"rf_power":  8, "pa_gain": 1, "dac_gain": 3, "mix_gain":  6, "dig_gain": 0},
                {"rf_power": 10, "pa_gain": 1, "dac_gain": 3, "mix_gain":  6, "dig_gain": 0},
                {"rf_power": 14, "pa_gain": 1, "dac_gain": 3, "mix_gain":  7, "dig_gain": 0},
                {"rf_power": 15, "pa_gain": 1, "dac_gain": 3, "mix_gain":  8, "dig_gain": 0},
                {"rf_power": 17, "pa_gain": 1, "dac_gain": 3, "mix_gain":  9, "dig_gain": 0},
                {"rf_power": 19, "pa_gain": 1, "dac_gain": 3, "mix_gain": 10, "dig_gain": 0},
                {"rf_power": 20, "pa_gain": 1, "dac_gain": 3, "mix_gain": 11, "dig_gain": 0},
                {"rf_power": 21, "pa_gain": 1, "dac_gain": 3, "mix_gain": 12, "dig_gain": 0},
                {"rf_power": 23, "pa_gain": 1, "dac_gain": 3, "mix_gain": 13, "dig_gain": 0},
                {"rf_power": 24, "pa_gain": 1, "dac_gain": 3, "mix_gain": 14, "dig_gain": 0},
                {"rf_power": 25, "pa_gain": 1, "dac_gain": 3, "mix_gain": 15, "dig_gain": 0}
            ]
        },
        "radio_1": {
            "enable": true,
            ...
            "freq": 471400000,
            "rssi_offset": -205.0,
			"rssi_tcomp": {"coeff_a": 0, "coeff_b": 0, "coeff_c": 9.97, "coeff_d": -2748.33, "coeff_e": 0},
            "tx_enable": false
        },
        "chan_multiSF_All": {"spreading_factor_enable": [ 5, 6, 7, 8, 9, 10, 11, 12 ]},
        "chan_multiSF_0": { "enable": true, "radio": 1, "if": -300000 },
...
Enter the util_spectral_scan directory, and execute the `./spectral_scan` command to start the background noise scan. The noise floor scanning function is very easy to operate, you only need to fill in the start frequency point and the number of channels to be scanned in the command parameters. The default step is 200000HZ, the number of samples is 2000, the rssi_offset 470 half-duplex module compensation is -20dB, the 868 half-duplex module compensation is -10dB, the 915 half-duplex module compensation is -20dB, and the 470 full-duplex module compensation is -20dB. The wider the bandwidth of the scan, the longer it will take. It is generally recommended to scan only 2MHz or 5MHz to cover the target working frequency band. **Note: Due to hardware reasons, the 470 module can only scan 470~490Mhz, the 868 module can only scan 862~876Mhz, and the 915 module can only scan 902~928Mhz. **

```
$> ./spectral_scan -f 471 -n 6 -o -20
==
