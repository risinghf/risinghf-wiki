...
**URL:** `https://cloud.iotsquare.xyz/openapi/relay/device/downlink`
...
**URL:** `/openapi/relay/device/status`
...
### 5.4 Get the list of relay slave devices

**URL:** `/openapi/relay/device/slaveList`
...
````json
{
  ...
  "data": [
    {
      "devEUI": "76325350002c0044", // slave device DevEUI
      "devAddr": "00f004af", // slave device addr
      "devName": "rxhf-repeater-01", // slave device name
      "status": 0, // status -1 unknown; 0 active; 1 invalid; 2 active unbinding; 3 automatic unbinding; 4. unbinding
      "createtime": 1663832014299, // slave creation time
      "updatetime": 1663916263036, // slave update time
      "appID": 10, // app ID
      "appName": "rxhf-test", // application name
      "rssi": -88, // Received signal strength
      "snr": "-0.8", // SNR
      "freq": "868.3", // frequency
      "dr": 0, // DR
      "lastSeen": 1663901063459, // last communication time
      "gwName": "rxhf-test-eu868", // gateway name
      "gwID": "24e124fffef374f9" // Gateway ID
    },
    ....
  ],
  "amount": 16 // Total number of slave devices list
}
````