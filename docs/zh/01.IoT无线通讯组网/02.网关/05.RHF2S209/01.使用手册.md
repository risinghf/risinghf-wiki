...
IoTSquare（[https://IoTSquare.xyz](https://iotsquare.xyz/)）是用于连接IoTSquare服务器的程序。它主要由两部分构成，一个是bridge，另一个是Packet Forwarder。
...
访问https://iotsquare.xyz/服务器，并且登录账号。如果没有账号，请与我司商务沟通，协助帮忙注册账号。
