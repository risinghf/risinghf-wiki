...
1. 如果电脑通过WiFi连接到网关设备，可以使用默认ip 192.168.8.1打开浏览器来登录内置web配置界面。
   ...
   ![image-20220401114330687](https://risinghf-wiki.oss-cn-shenzhen.aliyuncs.com/upload/img/image-20220401114330687.png)

2. 如果电脑和网关设备在同一个局域网下，可以使用 DHCP ip打开浏览器来登录内置web配置界面，以192.168.31.49为例。
